...
export default function Page(){
 ...
 <p style={{opacity:.75,marginTop:16}}>Após a confirmação do Mercado Pago, o Premium é ativado automaticamente. A confirmação pode levar alguns instantes.</p></section>}
